...
// import 'package:medskin/chatScreen/mainScreens/Preview/imagePreview_Screen.dart';
...
// import 'package:medskin/chatScreen/mainScreens/global_Uses/constant.dart';
// import 'package:medskin/chatScreen/mainScreens/global_Uses/enum_generation.dart';
// import 'package:medskin/chatScreen/mainScreens/global_Uses/native_Calling.dart';
// import 'package:medskin/chatScreen/mainScreens/global_Uses/show_toastMessage.dart';
...
//     this._chatBoxHeight = MediaQuery
//         .of(context)
//         .size
//         .height - 160;
//
...
//                   child: CircleList(
//                     initialAngle: 55,
//                     outerRadius: MediaQuery
//                         .of(context)
//                         .size
//                         .width / 3.2,
//                     innerRadius: MediaQuery
//                         .of(context)
//                         .size
//                         .width / 10,
...
//   }
//
//   Widget _textConversationManagement(BuildContext itemBuilderContext,
//       int index) {
//     return Column(
...
//   }
//
//   Widget _mediaConversationManagement(BuildContext itemBuilderContext,
//       int index) {
//     return Column(
//       children: [
//         Container(
...
//                                   ChatMessageTypes.Image
//                                   ? this._allConversationMessages[index].keys
//                                   .first
//                                   : this
//                                   ._allConversationMessages[index]
//                                   .keys
...
//                             onPressed: () async {
//                               print(
//                                   "Opening Path is: ${this
//                                       ._allConversationMessages[index].keys
//                                       .first.split("+")[1]}");
//
...
//   }
//
//   Widget _documentConversationManagement(BuildContext itemBuilderContext,
//       int index) {
//     return Column(
//       children: [
//         Container(
...
//   }
//
//   Widget _locationConversationManagement(BuildContext itemBuilderContext,
//       int index) {
...
//   }
//
//   Widget _audioConversationManagement(BuildContext itemBuilderContext,
//       int index) {
//     return Column(
//       mainAxisAlignment: MainAxisAlignment.spaceAround,
//       children: [
...
//                       )
//                           : Text(
//                         '${this._audioPlayingSpeed.toString().contains('.0')
//                             ? this._audioPlayingSpeed.toString().split('.')[0]
//                             : this._audioPlayingSpeed}x',
//                         style: TextStyle(
...
//             _loadingTime =
//             '${event.inMinutes} : ${event.inSeconds > 59
//                 ? event.inSeconds % 60
//                 : event.inSeconds}';
//           });
//         }
...
//                 .duration.inSeconds > 59 ? _justAudioPlayer.duration.inSeconds %
//                 60 : _justAudioPlayer.duration.inSeconds}';
...
//     final Map<String, dynamic> _connectionsList = docs[_firestoreFieldConstants.connections];
//
