...
import 'package:medskin/chatScreen/mainScreens/AuthUI/sign_up.dart';

import 'log_in.dart';

Widget commonTextFormField({ String hintText, String Function(String) validator, TextEditingController textEditingController, double bottomPadding = 50.0}) {
  return Container(
