...
class DoctorBottomPage extends StatefulWidget {
  @override
  _DoctorBottomPageState createState() => _DoctorBottomPageState();
}

class _DoctorBottomPageState extends State<DoctorBottomPage> {
