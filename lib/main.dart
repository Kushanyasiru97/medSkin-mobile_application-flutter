...
// import 'new/FrontEnd/MainScreens/main_screen.dart';
// import 'new/FrontEnd/NewUserEntry/new_user_entry.dart';
// import 'new/Global_Uses/foreground_receive_notificaion_management.dart';
// import 'uh/bottom_page.dart';
...
Future<Widget> differentContextDecisionTake() async {
  if (FirebaseAuth.instance.currentUser == null) {
    ...
    return _dataPresentResponse ? MainScreen() : BottomPage();
  }
}
